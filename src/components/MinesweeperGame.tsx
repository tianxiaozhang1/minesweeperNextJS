...
const MinesweeperGame: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      {/* TOGGLE */}
      <div className='hidden justify-end mx-2 -mb-2'>
          <div className='h-10 w-20  border-[2px] border-l-slate-400 border-t-slate-400 border-b-slate-600 border-r-slate-600
                                  hover:border-l-slate-600 hover:border-t-slate-600 hover:border-b-slate-400 hover:border-r-slate-400'>
              {/* <Image
                  src={getSmileySrc()}
                  alt="Smiley Face"
                  width={32}
          ...
          >
              ...
              <div className="text-lg font-semibold text-gray-700 bg-slate-800">
                ...
                <div className='flex'>
                    ...
                    {/* <div className='w-12 h-full bg-red-600'></div> */}

                    {/* <div className='bg-red-600 w-20'>x</div> */}
                </div>
              </div>
          </div>
      ...
      {/* <div className='w-full flex justify-center -mt-2'>
          <div className='w-32 h-12 bg-slate-600'></div>
      </div> */}
    </div>
  );
};
